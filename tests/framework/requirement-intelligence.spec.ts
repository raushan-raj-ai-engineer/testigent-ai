...
test('generated proposal follows enterprise architecture, target-app tags and stays review blocked', async () => {
  ...
  try {
    ...
    expect(generatedTest).toContain('enterprise.fixture.js'); expect(generatedTest).toContain('@app:billing'); expect(generatedTest).toContain('test.fixme'); expect(generatedTest).toContain('test.step(');
