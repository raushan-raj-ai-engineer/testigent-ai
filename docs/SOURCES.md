...
10. SheetJS, “Security.” https://docs.sheetjs.com/docs/miscellany/security/ — upstream security/version notes for SheetJS. This repository vendors `xlsx-0.20.3.tgz`; `security:check` evaluates HIGH/CRITICAL findings by exact advisory ID and affected range. Exceptions require rationale, owner and expiry, and do not automatically cover future advisories for the same package/version.
